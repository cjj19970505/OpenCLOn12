...
static ComPtr<ID3DBlob> SerializeRootSignature(CompiledDxil::Metadata const& metadata)
{
    ...
    // TODO: Make this root UAVs instead
    ViewRanges[NumRanges++].Init(D3D12_DESCRIPTOR_RANGE_TYPE_UAV, metadata.num_uavs, 0, 1, D3D12_DESCRIPTOR_RANGE_FLAG_DATA_VOLATILE, 2);
